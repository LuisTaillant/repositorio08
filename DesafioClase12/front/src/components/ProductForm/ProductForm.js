      ...
      <div className="cart-summary col-8 col-md-5 my-auto pt-3">
        ...
        >
          ...
          <div className="cart-btn mt-100 row justify-content-center">
            <button
              type="submit"
              className="mt-1 col-5 btnCheckout mb-3 fs-4"
          ...
          <div className="cart-btn mt-100 row justify-content-center">
            <button
              type="submit"
              className="mt-1 col-5 btnCheckout mb-1 fs-4"
