...
routerAdmin.post("/", async (req, res) => {
  ...
  if (userName === "coderhouse" && password === "123456") {
    //localhost:8080/api/admin/login?userName=coderhouse&password=123456
...
routerAdmin.get("/prueba", autorization, (req, res) => {
  //http://localhost:8080/api/admin/prueba
  res.send("Autorizado");
});
...
routerAdmin.put("/productos/:id", autorization, (req, res) => {
  //localhost:8080/api/admin/productos/627538fe498e9db6791b15eb
